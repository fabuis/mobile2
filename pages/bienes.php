...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Informe de Bienes</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
            	<div class="col-lg-6">
            		<div class="alert alert-success" role="alert">Bienes Deudores</div>
            		<a href="bienes_deudor/add_bien.php" class="cargar"><button type="button" class="btn btn-outline btn-primary">Agregar</button></a>
                <hr>
            	...
            	<div class="col-lg-6">
           			<div class="alert alert-success" role="alert">Bienes Codeudor</div>
           			<a href="bienes_codeudor/add_bien.php" class="cargar"><button type="button" class="btn btn-outline btn-primary">Agregar</button></a>
  					<hr>
            		<div class="panel-body">
              		<div class="dataTable_wrapper">
                    	<table class="table table-striped table-bordered table-hover" id="dataTables-example2" style="font-size:13px">
                        	<thead>
                            <tr>
                                <th>Cédula</th>
                                <th>Tipo</th>
