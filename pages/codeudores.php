...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Codeudores</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
            	<div class="col-lg-12">
            		<a href="codeudores/add_codeudor.php" class="cargar"><button type="button" class="btn btn-outline btn-primary">Agregar Codeudor</button></a>
                <hr>
