...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Entidad o Despacho, Sección y/o Especialidad</h1>
                	<a href="despachos/add_despacho.php" class="cargar"><button type="button" class="btn btn-outline btn-primary">Agregar Despacho</button></a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
            	...
            	<div class="panel-body">
              		<div class="dataTable_wrapper">
                    	<table class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size:13px">
                            ...
                            <tr>
                                <th>Ciudad</th>
                                <th>Nombre de la Entidad o Despacho - Seccion y/o Especialidad</th>
								<th>Opciones</th>
                            </tr>
                            </thead>
                      	<tbody>
							   	...
							   	<?php 
									echo funct_despachos("jur_despachos");
								?>
