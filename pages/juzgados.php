...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="juzgados.php"><i class="fa fa-table fa-fw"></i> Juzgados</a>
                        </li>
                        <li>
                            <a href="despachos.php"><i class="fa fa-table fa-fw"></i> Despachos</a>
                        </li>
                        <li>
                            <a href="codeudores.php"><i class="fa fa-table fa-fw"></i> Codeudores</a>
                        </li>
                        <li>
                            <a href="abogados.php"><i class="fa fa-table fa-fw"></i> Abogados</a>
                        </li>
                        <li>
                            <a href="bienes.php"><i class="fa fa-table fa-fw"></i> Bienes</a>
                        </li>
                        <li>
                            <a href="usuarios.php"><i class="fa fa-bar-chart-o fa-fw"></i> Usuarios</a>
                        </li>
                        <li>
                            <a href="parametrizacion.php"><i class="fa fa-table fa-fw"></i> Parametrización</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Corporación, Juzgado o Entidad</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
            	...
            	<div class="panel-body">
              		<div class="dataTable_wrapper">
                    	<table class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size:13px">
                            ...
                            <tr>
                                <th>Código</th>
                                <th>Nombre de la Corporación</th>
                            </tr>
                            </thead>
                      	<tbody>
                      		<?php funct_juzgados(); ?>
